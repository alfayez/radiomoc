...
if __name__ == "__main__":
    ...
    print "token_size_pass= ", options.token_size_pass, " vect_factor_pass= ", options.vect_factor_pass, "alloc_policy_pass= ", options.alloc_policy_pass, " run_time=", options.run_time_pass, " out-file= ", options.out_file_pass
    exit(-1)
