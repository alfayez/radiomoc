...
# Generated: Wed May 22 21:18:08 2013
##################################################
...
class OCCAM_generated(grc_wxgui.top_block_gui):
	...
	def __init__(self):
		...
		self.digital_mpsk_snr_est_cc_0 = digital.mpsk_snr_est_cc(2, 100000000, 0.001)
		...
		self.dataSrc = gr.file_source(gr.sizeof_float*1, "music-tx1.0.dat", True)
		...
		self.connect((self.digital_mpsk_snr_est_cc_0, 0), (self.blocks_conjugate_cc_0, 0))
		self.connect((self.digital_mpsk_snr_est_cc_0, 0), (self.blocks_multiply_xx_0, 0))
		self.connect((self.blocks_conjugate_cc_0, 0), (self.blocks_multiply_xx_0, 1))
		self.connect((self.blocks_multiply_xx_0, 0), (self.wxgui_numbersink2_0, 0))
		self.connect((self.add, 0), (self.digital_mpsk_snr_est_cc_0, 0))
