...
# Generated: Wed Feb 20 15:08:44 2013
##################################################
...
class OCCAM_generated(grc_wxgui.top_block_gui):
	...
	def __init__(self):
		...
		self.dataOut = scopesink2.scope_sink_f(
			self.GetWin(),
			title="Data Out",
		...
		self.connect((self.uhd_usrp_source_0, 0), (self.rfScale2, 0))
	...
	def set_samplingRate(self, samplingRate):
		...
		self.dataOut.set_sample_rate(self.samplingRate)
	...
	def set_gaussGain(self, gaussGain):
		...
		self.rfScale2.set_k((self.gaussGain, ))
